...
> **Fork of [blader/humanizer](https://github.com/blader/humanizer) (MIT)**
> Vendorized into hmbot-wizedev arsenal 2026-08-29. All credit to original author.

Humanizer переписывает текст, звучащий как ИИ, чтобы он читался как написанный человеком, не меняя его смысла. Поскольку это просто Markdown, он работает с любым агентом, поддерживающим навыки.
